...
const firebaseConfig = {
  ...
  storageBucket: "ecnv1-a8573.appspot.com",
  messagingSenderId: "202608859524",
  appId: "1:202608859524:web:f5280c4d9e253f078e65d1",
  measurementId: "G-ZDP4WRV40Z"
};
...
function buildLococationConductoresList(data) {
    ...
    for (let i = 0; i < arraySize; i++) {
        ...
        link.innerHTML =
            ...
            '<p>' + conductor.lectura + '</p>' +
            '<p>' + conductor.facturado + '</p>' +
...
var cars_Ref = firebase.database().ref('/BENLESA');


var dataConductores = firebase.database().ref('/BENLESA');
